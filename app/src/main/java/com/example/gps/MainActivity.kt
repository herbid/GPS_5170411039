...
class MainActivity : AppCompatActivity() {
    ...
    when(requestCode){
        REQUEST_CODE->{
            ...
            {
                if (grantResults[0]==PackageManager.PERMISSION_GRANTED)Toast.makeText(this@MainActivity,"permition granted",
            ...
            btn_stop_update.setOnClickListener(View.OnClickListener {
                if (ActivityCompat.checkSelfPermission(
                    ...
                    ActivityCompat.requestPermissions(
                        this@MainActivity, arrayOf(android.Manifest.permission.ACCESS_FINE_LOCATION),REQUEST_CODE
                    )
                    return@OnClickListener
    ...
    private fun buildLocationCallBack(){
        locationCallback=object : LocationCallback(){
            ...
            override fun onLocationResult(p0: LocationResult?) {
                ...
                text_location.text= location.latitude.toString()+"/"+location.toString()
            }
